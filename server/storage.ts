import { type User, type InsertUser, type DailyMenu, type InsertDailyMenu, type MenuItemDB, type InsertMenuItem, type GeneratedImage, users, dailyMenus, menuItems, generatedImages } from "@shared/schema";
import { db } from "./db";
